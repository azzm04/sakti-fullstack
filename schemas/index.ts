...
export const CandidateDataSchema = z.object({
  ...
  // Status sosial
  aktif_dtsen: z.string().default(""),
  validasi_aktif_dtsen: z.string().default(""),
  desil_dtsen: z.string().default(""),
  validasi_desil_dtsen: z.string().default(""),
...
export const KandidatBaseSchema = z.object({
  ...
  aktif_dtsen: z.string().nullable().optional(),
  validasi_aktif_dtsen: z.string().nullable().optional(),
  desil_dtsen: z.string().nullable().optional(),
  validasi_desil_dtsen: z.string().nullable().optional(),
...
export function autoHasilAkhir(
...
export const KuotaPewawancaraSchema = z.object({
  ...
  pewawancara: z
    .object({ nama: z.string(), email: z.string() })
    .nullable()
    .optional(),
});
...
export const SesiListItemSchema = z.object({
  ...
  kuota_saya: z
    .object({ kuota_ke: z.number(), claimed_at: z.string() })
    .nullable(),
  kuota_list: z
    .array(
      z.object({
...
export const WarStatusSchema = z.object({
  ...
  sesi: SesiWawancaraSchema.pick({
    id: true,
    tanggal: true,
    kuota_pewawancara: true,
    kuota_mahasiswa: true,
    war_dibuka_at: true,
    distribusi_done: true,
  }).nullable(),
